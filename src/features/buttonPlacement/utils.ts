...
import { type AllButtonNames, type ButtonPlacement, type FeatureButtonId, type MultiButtonNames, type SingleButtonFeatureNames } from "@/src/types";
...
export function getFeatureButtonId(buttonName: AllButtonNames): FeatureButtonId {
	return `yte-feature-${buttonName}-button`;
}
