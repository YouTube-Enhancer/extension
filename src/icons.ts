...
type FeatureIconFactoryMap = {
	[ButtonName in AllButtonNames]: {
		...
		shared_icon_position: FactoryIconType<ButtonName>;
	};
};
type ToggleIconFactory = { off: BasicIconFactory; on: BasicIconFactory };
...
const decreasePlaybackSpeedButtonSVG = () =>
	createSVGElement(
		"svg",
		{
			height: "24px",
...
const increasePlaybackSpeedButtonSVG = () =>
	createSVGElement(
		"svg",
		{
			height: "24px",
...
const hideEndScreenCardsButtonSVG = () =>
	createSVGElement(
		"svg",
		{
			height: "24px",
...
const showEndScreenCardsButtonSVG = () =>
	createSVGElement(
		"svg",
		{
			height: "24px",
...
export const miniPlayerOnSVG = () =>
	createSVGElement(
		"svg",
		{ fill: "none", height: "24px", viewBox: "0 0 24 24", width: "24px" },
		createSVGElement("path", {
			d: "M5 5.5H19A2 2 0 0 1 21 7.5V16.5A2 2 0 0 1 19 18.5H5A2 2 0 0 1 3 16.5V7.5A2 2 0 0 1 5 5.5Z",
			stroke: "currentColor",
			"stroke-width": "1.25"
		}),
		createSVGElement("path", {
			d: "M13.2 12H18.4A1 1 0 0 1 19.4 13V16.2A1 1 0 0 1 18.4 17.2H13.2A1 1 0 0 1 12.2 16.2V13A1 1 0 0 1 13.2 12Z",
			fill: "currentColor"
		})
	);
export const miniPlayerOffSVG = () =>
	createSVGElement(
		"svg",
		{ fill: "none", height: "24px", viewBox: "0 0 24 24", width: "24px" },
		createSVGElement("path", {
...
export const monoToStereoOnSVG = () =>
	createSVGElement(
		"svg",
...
export const monoToStereoOffSVG = () =>
	createSVGElement(
		"svg",
		{ fill: "white", height: "24px", viewBox: "0 0 24 24", width: "24px" },
		createSVGElement("path", {
...
export function getFeatureIcon<Name extends AllButtonNames>(featureName: Name, placement: ButtonPlacement): IconType<Name> {
	...
	if (cached) return cached as IconType<Name>;
	const {
