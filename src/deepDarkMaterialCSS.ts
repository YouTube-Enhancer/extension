...
* {
	...
	--yt-spec-brand-button-background: var(--main-color) !important; /*in incognito this may be used as subscribe button but is inconsistent .yt-spec-button-shape-next--brand.yt-spec-button-shape-next--filled*/

	--yt-formatted-string-bold-color: var(--dimmer-text) !important; /*this affects number of views*/

	--yt-lightsource-section1-color: var(--main-background) !important; /* watch history header */
	...
	--yt-spec-themed-blue: var(--main-color) !important;
	...
	--light-primary-color: var(--main-color) !important;
	--dark-primary-color: var(--main-color) !important;
	--accent-color: var(--main-color) !important;
	--light-accent-color: var(--main-color) !important;
	--dark-accent-color: var(--main-color) !important;
	--light-theme-background-color: var(--main-background) !important;
	--light-theme-base-color: var(--main-text) !important;
	--light-theme-text-color: var(--main-text) !important;
	--light-theme-secondary-color: var(--dimmer-text) !important;
	--light-theme-disabled-color: var(--second-background) !important;
	--light-theme-divider-color: var(--hover-background) !important;
	--yt-sys-color-baseline--text-primary: var(--main-text) !important;
	--yt-sys-color-baseline--text-secondary: var(--dimmer-text) !important;
	/*chapters / timeline / transcript*/
	--yt-sys-color-baseline--raised-background: var(--second-background) !important;
	--yt-sys-color-baseline--outline: var(--hover-background) !important;
	--timestamp-active-color: var(--main-color) !important;
	--yt-sys-color-baseline--base-background: var(--main-background) !important;
	--yt-sys-color-baseline--outline: var(--hover-background) !important;
...
html, ytd-browse, ytd-watch, ytd-search, ytd-app, ytd-app[is-watch-page],
[class*="ytd-watch-flexy"]:not(#engagement-panel-scrim):not(#secondary):not(#secondary-split-scroll-spacer),
...
.title.ytd-guide-entry-renderer /*2026-04-28*/ {
	color: var(--main-text) !important;
}
...
/*fix for light theme video hover on the main page*/
...
yt-chip-cloud-chip-renderer[selected] #chip-container.yt-chip-cloud-chip-container,
yt-chip-cloud-chip-renderer:hover #chip-container.yt-chip-cloud-chip-container,
.ytChipShapeButtonReset[aria-selected="true"] .ytChipShapeActive {
	background-color: var(--hover-background) !important;
	color: var(--main-color) !important;
}
...
.yt-spec-button-shape-next.yt-spec-button-shape-next--text.yt-spec-button-shape-next--mono.yt-spec-button-shape-next--size-m.yt-spec-button-shape-next--icon-only-default.yt-spec-button-shape-next--enable-backdrop-filter-experiment:hover {
	color: var(--main-color) !important;
}
...
/*2025-09-04 - YouTube Small Thumbnails addon issue*/
#frosted-glass.with-chipbar.ytd-app {
	background: var(--main-background) !important;
}

/*video recommendation filter*/
...
.ytChipsShelfViewModelGradientButton .ytChipsShelfViewModelRightArrow {
	background: var(--hover-background) !important;
}
...
#page-header-container.ytd-tabbed-page-header, #tabs-container.ytd-tabbed-page-header {
	background-color: var(--main-background) !important;
}
/*header*/
...
.truncated-text-wiz,
.yt-truncated-text__truncated-text-content {
	color: var(--dimmer-text) !important;
}
/*show more*/
...
.yt-tab-shape__tab, /*2025-08-30*/
.ytTabShapeTab /*2026-04-09*/ {
	color: var(--main-text) !important;
}
...
.ytTabShapeTabSelected /*2026-04-09*/ {
	color: var(--main-color) !important;
}
tp-yt-paper-tabs {
...
.yt-tab-shape__tab-bar--tab-bar-selected,
.ytTabShapeHost:hover .ytTabShapeTabBar /*2026-04-09*/ {
	background-color: var(--main-color) !important;
...
.title.ytd-recognition-shelf-renderer /*members on channel page*/ {
	color: var(--main-text);
}
.title:hover {
	color: var(--main-color) !important;
...
/*affects links in video descriptions*/
...
#content-attachment.ytd-backstage-post-renderer ytd-video-renderer.ytd-backstage-post-renderer,    /*normal video*/
#content-attachment.ytd-backstage-post-renderer ytd-playlist-renderer.ytd-backstage-post-renderer, /*playlist*/
#content-attachment.ytd-post-renderer ytd-video-renderer.ytd-post-renderer,   /*normal video, but in cards on home page*/
#content-attachment.ytd-post-renderer ytd-playlist-renderer.ytd-post-renderer /*playlist, but in cards on home page*/ {
	background: var(--hover-background) !important;
}
...
/*icons*/
yt-icon.ytd-unified-share-panel-renderer > span > div, /*close icon*/
yt-icon.ytd-unified-share-panel-renderer > yt-icon-shape > icon-shape > div,
#scroll-button-forward > button > yt-icon > span > div, /*next arrow*/
...
yt-share-target-renderer.style-scope:nth-child(5) > button > yt-icon > span > div /*email icon*/,
.ytSpecButtonShapeNextMono.ytSpecButtonShapeNextTonal, /*2026-04-21*/
...
/*2025-10-25 personalized notification bell icon*/
.style-scope.ytd-subscribe-button-renderer ytd-lottie-player > lottie-component > svg > g > g > path {
	fill: var(--main-text) !important;
}
...
/*home page titles - 2024-11-17*/
.yt-lockup-metadata-view-model-wiz__title:hover,
/*2025-08-30*/
.yt-lockup-metadata-view-model__title:hover,
/*2026-04-09*/
.ytLockupMetadataViewModelTitle:hover,
.ytLockupMetadataViewModelCompact:hover .ytLockupMetadataViewModelTitle .ytAttributedStringWhiteSpacePreWrap {
	color: var(--main-color) !important;
}
/*author*/
...
.yt-content-metadata-view-model-wiz__metadata-row:first-child .yt-core-attributed-string--link-inherit-color,
/*2025-08-30*/
.yt-content-metadata-view-model__metadata-row:nth-child(1) > .yt-core-attributed-string,
/*2026-04-09*/
.ytContentMetadataViewModelMetadataRow:first-child > span:first-child,
.ytContentMetadataViewModelMetadataRow:first-child > span:nth-child(2) {
	color: var(--main-color) !important;
}
/*collaborators / multiple authors*/
...
/*arrow icon for views*/
.ytContentMetadataViewModelLeadingIcon svg {
	fill: var(--dimmer-text) !important;
}
/*new badge*/
.yt-badge-shape--default, /*2025-08-30*/
.ytBadgeShapeDefault /*2026-04-13*/ {
	color: var(--main-color) !important;
	background: var(--hover-background) !important;
}
/*check badge*/
...
/*2025-08-30*/
.yt-content-metadata-view-model__metadata-row:nth-child(1) > .yt-core-attributed-string--link-inherit-color > span,
/*2026-04-09*/
.ytContentMetadataViewModelMetadataRow:first-child .yt-core-attributed-string--link-inherit-color,
ytd-author-comment-badge-renderer[standardize-icon-size]:not([creator]) #icon.ytd-author-comment-badge-renderer {
	color: var(--main-color) !important;
}
.ytAttributedStringInlineBlockMod > span > span > div > svg {
	fill: var(--main-color) !important;
}
/*featured badge*/
.yt-badge-shape--promoted,
.ytBadgeShapePromoted /*2026-04-19*/ {
	color: var(--main-color) !important;
	background: var(--hover-background) !important;
	padding-left: 4px;
}
...
.ytBadgeShapeCommerce /*2026-04-19*/ {
	color: var(--main-color) !important;
	background: var(--hover-background) !important;
}
/*2025-10-15*/
/*hover card on home page*/
.yt-spec-touch-feedback-shape__hover-effect {
	background: var(--hover-background) !important;
}

/*youtube channel in the watch next sidebar*/
/*ytd-item-section-renderer.ytd-watch-next-secondary-results-renderer #metadata.ytd-channel-renderer*/
ytd-item-section-renderer.ytd-watch-next-secondary-results-renderer #description.ytd-channel-renderer {
	display: none;
}
ytd-item-section-renderer.ytd-watch-next-secondary-results-renderer #info-section.ytd-channel-renderer {
	flex-direction: column !important;
	padding: 0 !important;
}
ytd-item-section-renderer.ytd-watch-next-secondary-results-renderer #avatar-section.ytd-channel-renderer {
	margin: 10px 10px 10px -20px !important;
}

/*info banner below video, such as "news" or "doctor"*/
ytd-info-panel-content-renderer[has-menu],
ytd-info-panel-content-renderer .content.ytd-info-panel-content-renderer,
...
.inline-source.ytd-info-panel-content-renderer, /*link*/
...
/*video description*/
#description:not([class*="yt-music"]):not([class*="ytd-channel-video-player-renderer"]),
#bio, #right-column > yt-formatted-string {
	background: var(--second-background) !important;
	color: var(--dimmer-text) !important;
}
#description-inner #expand.ytd-text-inline-expander,
#description-inner.ytd-watch-metadata .style-scope.ytd-watch-info-text,
#description-inner.ytd-watch-metadata .style-scope.yt-formatted-string {
	color: var(--main-text) !important;
}
.ytwHowThisWasMadeSectionViewModelBodyHeader,
.YtwHowThisWasMadeSectionViewModelBodyHeader,
#description-inner.ytd-watch-metadata:hover #expand.ytd-text-inline-expander {
	color: var(--main-color) !important;
}
...
/*2025-10-25 video description hpver*/
ytd-watch-metadata[description-collapsed][enable-color-sampling] #description.ytd-watch-metadata:hover {
	background-color: var(--hover-background) !important;
}
ytd-watch-metadata[description-collapsed][enable-color-sampling] #description.ytd-watch-metadata:hover ytd-watch-info-text.ytd-watch-metadata,
ytd-watch-metadata[description-collapsed][enable-color-sampling] #description.ytd-watch-metadata:hover #expand {
	color: var(--main-text) !important;
}
...
ytd-menu-renderer.ytd-watch-metadata > div:nth-child(1) > segmented-like-dislike-button-view-model:nth-child(1) > yt-smartimation:nth-child(1) > div:nth-child(1) > div:nth-child(1) > like-button-view-model:nth-child(1) > toggle-button-view-model:nth-child(1) > button-view-model:nth-child(1) > button:nth-child(1) > div:nth-child(1) > yt-icon:nth-child(1) > yt-animated-icon:nth-child(1) > ytd-lottie-player:nth-child(1) > lottie-component:nth-child(1) > svg:nth-child(1) > g:nth-child(2) > g:nth-child(1) > g:nth-child(6) > g:nth-child(2) > path:nth-child(1),
/*2025-10-22*/
yt-animated-icon[animated-icon-type="LIKE"] > ytd-lottie-player > lottie-component > svg > g:nth-child(2) > g:nth-child(10) > path:nth-child(1),
/*Custom like*/
yt-animated-icon[animated-icon-type="CUSTOM_LIKE"] > ytd-lottie-player > lottie-component > svg > g:nth-child(2) > g:nth-child(1) > g:nth-child(4) > path:nth-child(1) {
	fill: var(--main-text) !important;
}
/*liked*/
...
/*2024-10-24*/
like-button-view-model > toggle-button-view-model ytd-lottie-player > lottie-component > svg path:nth-child(1) {
	fill: var(--main-color) !important;
}
...
/*2026-06-25*/
/*hide strange gradient*/
[class*="ShapeStaticWashLight"], [class*="ShapeStaticWashLight"]::before,
[class*="ShapeStaticRimLight"], [class*="ShapeStaticRimLight"]::before {
...
#expand.ytd-text-inline-expander:hover, #collapse.ytd-text-inline-expander:hover {
	color: var(--main-color) !important;
}
...
.title-container-without-video-flexible.ytd-sponsorships-offer-renderer, /*2026-04-28*/
.offer-overview-item.ytd-sponsorships-offer-renderer yt-formatted-string.title.ytd-sponsorships-offer-renderer {
	color: var(--main-text) !important;
}
/*promo*/
...
/*price*/
.offer-overview-item.selected.ytd-sponsorships-offer-renderer {
	Background-color: var(--hover-background) !important;
}
...
.offer-overview-item.ytd-sponsorships-offer-renderer yt-formatted-string.subtitle.ytd-sponsorships-offer-renderer {
	color: var(--dimmer-text) !important;
}
/*perks*/
...
html[refresh]:not(.style-scope) {
	--paper-input-container-invalid-color: var(--main-color) !important;
}
...
/*2022 Nov changes*/
/*subscribe button*/
.yt-spec-button-shape-next--mono.yt-spec-button-shape-next--filled, /*Show more on home page; also shorts buttons*/
.yt-spec-button-shape-next--mono.yt-spec-button-shape-next--outline, /* as of oct 2023 */
...
.ytSpecButtonShapeNextMono.ytSpecButtonShapeNextFilled[aria-label*="Subscribe"] {
	background-color: var(--hover-background) !important;
	border-color: var(--hover-background) !important;
	box-shadow: var(--shadow) !important;
	color: var(--main-text) !important;
...
.ytSpecButtonShapeNextCallToAction.ytSpecButtonShapeNextText:hover {
...
.yt-spec-button-shape-next--call-to-action.yt-spec-button-shape-next--filled, /*in window*/
.ytSpecButtonShapeNextCallToAction.ytSpecButtonShapeNextFilled[aria-label*="Join"],
.ytSpecButtonShapeNextMono.ytSpecButtonShapeNextFilled[aria-label*="Join"] {
	background-color: var(--hover-background) !important;
	border-color: var(--hover-background) !important;
	color: var(--main-text) !important;
}

#subscribe-button-shape:hover .ytSpecButtonShapeNextMono.ytSpecButtonShapeNextFilled, /*2026-04-21*/
.ytSpecButtonShapeNextMono.ytSpecButtonShapeNextFilled[aria-label*="Subscribe"]:hover,
.ytSpecButtonShapeNextMono.ytSpecButtonShapeNextTonal[aria-label*="Join"]:hover, /*2026-04-21*/
.ytSpecButtonShapeNextCallToAction.ytSpecButtonShapeNextFilled[aria-label*="Join"]:hover,
.ytSpecButtonShapeNextMono.ytSpecButtonShapeNextFilled[aria-label*="Join"]:hover {
	background-color: var(--hover-background) !important;
	color: var(--main-color) !important;
}
...
#copy-button.yt-copy-link-renderer .ytSpecButtonShapeNextMono.ytSpecButtonShapeNextOutline {
	background-color: var(--main-color) !important;
	color: var(--main-text) !important;
}
...
/*2024-07 subscribe dropdown*/
.yt-contextual-sheet-layout-wiz,
/*2025-08-30 also triple dots for videos*/
.ytContextualSheetLayoutHost,
.ytSpecDialogLayoutHost /*2026-04-17*/ {
	background-color: var(--second-background) !important;
}
...
/*checkmark left unthemed, is a png for now*/
...
/*3 dots dropdown for videos*/
.ytListItemViewModelAccessory {
	color: var(--main-text) !important;
}
.ytListItemViewModelMainContainer:hover .ytListItemViewModelAccessory,
.ytListItemViewModelMainContainer:hover .ytListItemViewModelTitle {
	color: var(--main-color) !important;
	fill: var(--main-color) !important;
}
...
/*shorts metadata - on title click*/
.YtwFactoidRendererValue, .ytwFactoidRendererValue,
ytd-text-inline-expander {
	color: var(--main-text) !important;
}
.YtwFactoidRendererLabel, .ytwFactoidRendererLabel {
	color: var(--dimmer-text) !important;
}

/*2024-08-30*/
/*youtube shorts scrubber, progress bar*/
.YtProgressBarLineProgressBarPlayed, .ytProgressBarLineProgressBarPlayed,
.YtProgressBarPlayheadProgressBarPlayheadDot, .ytProgressBarPlayheadProgressBarPlayheadDot,
...
.ytp-delhi-modern .ytp-progress-list {
	background: rgba(162, 162, 162, 0.57) !important;
}
.ytp-volume-slider-track, .ytp-volume-slider-handle:before {
	/*2025-10-14 looks better in white in new design*/
	/*background: var(--main-color) !important;*/
	z-index: -117;
}
...
.ytPlayerOverlayVideoDetailsRendererSingleLineTitle.ytPlayerOverlayVideoDetailsRendererTitle {
	font-size: 3rem !important;
	text-shadow: 0 0 4px #000 !important;
}
/*remove button backgrounds*/
.ytp-chrome-controls .ytp-left-controls > *,
.ytp-chrome-controls .ytp-time-wrapper:not(.ytp-miniplayer-ui *),
...
.ytdMiniplayerToastOpening {
	background-color: var(--second-background) !important;
}
#label.ytd-miniplayer-toast,
.ytdMiniplayerToastLabel, .ytdMiniplayerToastTitle {
	color: var(--main-color) !important;
}
...
/*2024-08-02*/
#logo-icon > span > div > svg > svg > g:nth-child(1) > path:nth-child(1),
/*2024-10-23*/
[id^="yt-ringo2-svg_yt"] > g:nth-child(1) > path:nth-child(1),
[id^="yt-ringo2-red-svg_yt"] > g:nth-child(1) > path:nth-child(1) {
	fill: var(--main-color) !important;
}
...
/*204-08-03*/
#logo-icon > span > div > svg > svg > g:nth-child(2),
[id^="yt-ringo2-svg_yt"] > g:nth-child(2) > path,
[id^="yt-ringo2-red-svg_yt"] > g:nth-child(2) > path {
	fill: var(--main-text) !important;
}
...
/*Shorts logo*/
/*on home page*/
ytd-rich-section-renderer.style-scope > div > ytd-rich-shelf-renderer > div > div> div > h2 > yt-icon > span > div > svg > path:nth-child(1),
/*on video page*/
yt-icon.ytd-reel-shelf-renderer > span:nth-child(1) > div:nth-child(1) > svg:nth-child(1) > path:nth-child(1)
/*on searches*/
grid-shelf-view-model.ytGridShelfViewModelHost > yt-section-header-view-model > yt-shelf-header-layout > div:nth-child(1) > div:nth-child(1) > span:nth-child(1) > span:nth-child(1) > div:nth-child(1) > svg:nth-child(1) > path:nth-child(1) {
	fill: var(--main-color) !important;
}
...
ytd-transcript-footer-renderer, ytd-transcript-segment-list-renderer {
	background-color: var(--second-background) !important;
	border-bottom: 3px solid var(--hover-background) !important;
}
*/
ytd-playlist-panel-renderer:not([hide-header-text]) .title.ytd-playlist-panel-renderer {
	color: var(--main-text) !important;
}
...
.ytwMacroMarkersPanelItemViewModelHost:hover .ytwTranscriptSegmentViewModelTimestamp {
	color: var(--main-color) !important;
}
...
/*2024-10-27 also affects transcript titles too*/
.shelf-header-layout-wiz__title, .YtwTimelineChapterViewModelTitle,  .ytwTimelineChapterViewModelTitle,
/*2026-06-28*/
h3.ytd-macro-markers-list-item-renderer {
	color: var(--main-text) !important;
}
/*timestamp*/
#time.ytd-macro-markers-list-item-renderer,
/*2024-10-27*/
.YtwTimelineItemViewModelTimestamp, .ytwTimelineItemViewModelTimestamp {
	color: var(--main-color) !important;
	background-color: transparent !important;
...
.YtSearchboxComponentSearchButton:hover .yt-spec-icon-shape,
.ytSearchboxComponentSearchButton:hover .yt-spec-icon-shape {
	color: var(--main-color) !important;
}
/*2025-08-30 right search icon*/
.ytSearchboxComponentSearchButton > span:nth-child(1) > span:nth-child(1) > div:nth-child(1) > svg:nth-child(1) {
	color: var(--main-text) !important;
}
...
.YtSearchboxComponentInnerSearchIcon, .ytSearchboxComponentInnerSearchIcon {
	color: var(--main-text) !important;
}
#search-icon.ytd-searchbox:hover, #search-icon.ytd-searchbox:hover {
	color: var(--main-color) !important;
}
/*results 🔎 icon*/
.sbqs_c::before {
...
.YtSuggestionComponentIcon, .ytSuggestionComponentIcon {
	color: var(--main-text) !important;
}
/*Results backgrounds*/
.sbsb_a,.sbdd_b,
...
/*Text color*/
.gsfs,
.YtSuggestionComponentLeftContainer, .ytSuggestionComponentLeftContainer,
.YtSearchboxComponentReportButton, .ytSearchboxComponentReportButton,
.ytSuggestionComponentLeftContainer, .ytSuggestionComponentLeftContainer,
.ytSearchboxComponentReportButton, .ytSearchboxComponentReportButton,
...
.ytSearchboxComponentSuggestionsContainerFooter {
	display: none !important;
}
/*Hover and keyboard select background*/
.sbsb_c.gsfs:hover,.sbsb_d,
.YtSuggestionComponentSuggestion:hover, .ytSuggestionComponentSuggestion:hover {
	background-color: var(--hover-background) !important;
}
.sbfl_b {
	background-color: var(--second-background) !important;
...
/*chapters in search results; also summary*/
#prominent-collapsed-label.ytd-expandable-metadata-renderer /*chapters count*/ {
	color: var(--main-text) !important;
}
...
ytd-watch-card-compact-video-renderer[is-condensed] .title.ytd-watch-card-compact-video-renderer {
	color: var(--main-text) !important;
}
ytd-watch-card-compact-video-renderer[is-condensed] .subtitle.ytd-watch-card-compact-video-renderer {
	color: var(--dimmer-text) !important;
}
/*Similar results*/
...
#published-time-text.ytd-comment-view-model /*2026-04-28*/ {
	color: var(--dimmer-text) !important;
}
/*2025-12 thread indicator*/
.continuation.ytd-comment-view-model,
.ytSubThreadConnection, .ytSubThreadContinuation {
	border-color: var(--dimmer-text) !important;
	opacity: 0.3;
}
...
#vote-count-middle.ytd-comment-engagement-bar /*2026-04-28*/ {
	color: var(--dimmer-text) !important;
}
...
#label.ytd-pinned-comment-badge-renderer > span {
	color: var(--main-color) !important;
	opacity: 0.7;
}
...
.ytSpecButtonShapeNextCallToAction.ytSpecButtonShapeNextOutline:hover {
	color: var(--main-color) !important;
}
...
/*header*/
/*have this header the same as queue header*/
...
#author-name.yt-live-chat-author-chip:not(.member):not(.moderator), .style-scope.yt-live-chat-ninja-message-renderer {
	color: var(--main-text) !important;
}
...
.yt-spec-touch-feedback-shape--toch-response-inverse .yt-spec-touch-feedback-shape__fill {
	color: var(--main-text) !important;
}
...
#label-text.yt-live-chat-banner-poll-choice, #vote-percentage-text.yt-live-chat-banner-poll-choice,
yt-live-chat-poll-choice:not([has-voted]) #label-text.yt-live-chat-poll-choice,
.metadata.yt-live-chat-banner-poll-renderer, .metadata.yt-live-chat-poll-header-renderer {
	color: var(--dimmer-text) !important;
}
...
.yt-spec-button-shape-next--mono-inverse > div:nth-child(1) > yt-icon:nth-child(1) > span:nth-child(1) > div:nth-child(1) > svg:nth-child(1) {
	color: var(--main-text) !important;
}
/*Top Fans*/
/*2025-08-30*/
...
#live-chat-dialog-body.yt-live-chat-dialog-renderer yt-formatted-string.yt-live-chat-dialog-renderer > span {
	color: var(--main-text) !important;
}
...
/*Reporting*/
.introduction-header,
.ytWebReportFormReasonSelectPageViewModelHeader,
...
.yt-report-form-confirmation-page-view-model__law-enforcement-text,
...
.ytVideoAttributeViewModelTitle /*2026-04-26*/ {
	color: var(--main-text) !important;
}
...
/*music links*/
.style-scope.ytd-structured-description-content-renderer .ytSpecButtonShapeNextMono.ytSpecButtonShapeNextOutline {
	color: var(--main-text) !important;
}
.style-scope.ytd-structured-description-content-renderer .ytSpecButtonShapeNextMono.ytSpecButtonShapeNextOutline:hover {
	color: var(--main-color) !important;
}
...
ytd-compact-link-renderer[compact-link-style="compact-link-style-type-history-my-activity-link"] #primary-text-container.ytd-compact-link-renderer > #label.ytd-compact-link-renderer {
	color: var(--main-text) !important;
}
/*dialog confirm*/
...
ytd-item-section-renderer[use-chip-bar-view-model-header][page-subtype="playlist"] #header.ytd-item-section-renderer {
	background: var(--main-background) !important;
}
...
#invalid-token-redirect-warning-text /*h1*/ {
	color: var(--main-text) !important;
}
/*span*/
#redirect-main-text {
